...
const Contact = () => {
	...
	const handleSubmit = e => {
		...
		emailjs.sendForm('service_jtc8i1s', 'template_pqnu7hy', e.target, 'user_Pw3e1VAekshKvMvTVweFQ')
			.then((res) => {
				// console.log(res);
				if (res.status === 200) {
					setIsSending(false);
	...
	return (
		<>
			<HeaderNavbar />
			<main id="contact_page" className=" bg-white contact-page pt-16 md:pt-20">
						...
						<div className="contact-form-area flex flex-col md:flex-row-reverse md:justify-center">
							<div className="contact-details flex-initial md:pl-12 lg:pl-24 mb-12 md:mb-0">
								...
								<div className="mt-8">
									...
									<p className="text-sm">
										CarRev, <br />
										Eskaton Garden Road, Secretary Apartment Complex 14B, <br />
										Bangladesh.
									</p>
								</div>
								<div className="mt-8">
									...
									<p className="text-sm">
										<a href="mailto:demo@dummy.com">help@carrev.com</a>
									</p>
								</div>
								<div className="mt-8">
