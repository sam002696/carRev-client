				...
				<section className="py-8 lg:py-12">
					<div className="container text-sm leading-loose">
						...
						<ul>
							...
							<li>
								<p className="mt-2">
									<strong>Website</strong> refers to CarRev, accessible from{' '}
									<a
										href="https://carrev.web.app/"
										rel="external nofollow noopener noreferrer"
										target="_blank"
										className="text-blue-600"
									>
										https://carrev.web.app/
									</a>
								</p>
							</li>
							<li>
						...
						<ul>
							<li>
								<p className="mt-2">By email: help@carrev.web.app</p>
							</li>
							<li>
								<p className="mt-2">
									By visiting this page on our website:{' '}
									<Link to="/contact" className="text-blue-600">
										https://carrev.web.app/contact
									</Link>
								</p>
							</li>
						</ul>
