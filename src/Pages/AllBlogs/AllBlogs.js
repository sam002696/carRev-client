...
const AllBlogs = () => {
  ...
  useEffect(() => {
    setIsLoading(true);
    axios
      .get("https://carrev-server-production.up.railway.app/blogs")
      .then((res) => {
  ...
  return (
    <>
      ...
      <main
        id="all_blogs_page"
        className=" bg-white all-blogs-page pt-16 md:pt-20"
      >
        <section
          id="all_blogs"
          className="py-8 lg:py-12 bg-true-gray-100 bg-opacity-50"
        >
