...
const BlogDetail = () => {
  ...
  // load blog with id
  useEffect(() => {
    const url = `https://carrev-server-production.up.railway.app/blogs/${blogId}`;
  ...
  return (
    <>
      ...
      <main
        id="blog_detail_page"
        className=" bg-white blog-detail-page pt-16 md:pt-20"
      >
            ...
            <div className="md:flex md:justify-between md:space-x-4 xl:space-x-8 space-y-10 md:space-y-0">
              <div className="flex-grow-1 xl:max-w-screen-lg">
                <div className="product-detail-info h-full">
                  <div
                    className="image bg-gray-200 w-full md:min-h-250px"
