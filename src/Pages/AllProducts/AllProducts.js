...
const AllProducts = () => {
  ...
  return (
    <>
      <HeaderNavbar />
      <main
        id="all_products_page"
        className=" bg-white all-products-page pt-16 md:pt-20"
      >
        <section id="all_products" className="py-8 lg:py-12">
          ...
          <div className="container">
            ...
            <div className="text-center mt-10">
              {productsItems >= products.length ? (
                " "
              ) : (
                <button
                  className="border-2 p-3 font-my-title tracking-my-tiny text-gray-800 bg-red-300 hover:text-red-200 hover:bg-gray-800"
                  onClick={loadItems}
                >
                  Load More
                </button>
