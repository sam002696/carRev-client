...
const Footer = () => {
	...
	return (
		<footer id="footer_main" className="bg-my-primary-dark footer-text">
			<div className="container py-6 md:py-8 md:flex justify-between md:space-x-4 space-y-6 md:space-y-0">
				<div className="contact-info">
					...
					<p className="mt-4">
						<a href="mailto:help@carrev.com" className="footer-link">help@carrev.com</a>
					</p>
					<p className="mt-3">
			...
			<div className="container py-6 text-center">
				<div className="copyright">
					<p>
						&#169; {currentYear} CarRev By   <a href='https://github.com/sam002696' target="_blank" rel="noreferrer noopener" className="text-my-secondary-light"> Sadman Sakib</a>
					</p>
				</div>
			</div>
		</footer>
